...
const serviceConfig: Record<string, {
  ...
  'relaxing-massage': {
    ...
    descEn: 'Book a professional relaxing massage at your hotel, villa or Airbnb in Playa del Carmen. Certified therapists, organic oils, delivered to your door.',
  ...
  'deep-tissue-massage': {
    ...
    descEn: 'Expert deep tissue massage delivered to your villa, hotel or Airbnb in Playa del Carmen. Release chronic tension with certified therapists.',
  ...
  'four-hands-massage': {
    ...
    descEn: 'Experience a luxury four-hands massage at your villa or hotel in Playa del Carmen. Two certified therapists in perfect synchronicity.',
  ...
  'botica-signature': {
    ...
    descEn: 'Our exclusive signature ritual blending Swedish, Deep Tissue and Aromatherapy. The ultimate in-home spa experience in Playa del Carmen.',
  ...
  'personalized-massage': {
    ...
    descEn: 'A custom-tailored massage designed for your unique needs, delivered to your hotel or Airbnb in Playa del Carmen. Certified therapists.',
  ...
  'revitalizing-facial': {
    ...
    descEn: 'Professional organic facial treatment delivered to your villa or hotel in Playa del Carmen. Restore your skin\'s natural glow after a day at the beach.',
